Offcourse::Engine.routes.draw do
  ...
  get "/offcourse/fetch" => "offcourse#online"
  get "/offcourse/fetch/*path" => "offcourse#online"
  # below has manifest declared
  get "/offcourse/offline" => "offcourse#index"
  get "/offcourse/offline/*path" => "offcourse#index"
  get "/offcourse/sites" => "offcourse#index"
  get "/offcourse/sites/*path" => "offcourse#index"
